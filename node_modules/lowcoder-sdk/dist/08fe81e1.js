import { d as X, b as q, g as Y, p as G } from "./8dfa988b.js";
import J from "react";
function K(t, o) {
...
_.prototype._toSVG = function() {
  ...
  l.setAttributeNS(null, "width", n.width), l.setAttributeNS(null, "height", n.height), this._fromData(o, function(v, D, M) {
    ...
    if (!isNaN(v.control1.x) && !isNaN(v.control1.y) && !isNaN(v.control2.x) && !isNaN(v.control2.y)) {
      ...
      C.setAttribute("d", W), C.setAttribute("stroke-width", (D.end * 2.25).toFixed(3)), C.setAttribute("stroke", M), C.setAttribute("fill", "none"), C.setAttribute("stroke-linecap", "round"), l.appendChild(C);
    }
  }, function(v) {
...
const Z = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: _
}, Symbol.toStringTag, { value: "Module" })), tt = /* @__PURE__ */ X(Z);
var R = { exports: {} }, N;
function et() {
  return N || (N = 1, function(t, o) {
    (function(n, e) {
      ...
      return function(n) {
        ...
        function i(r) {
          var c = r.getContext("2d"), f = r.width, p = r.height, y = c.getImageData(0, 0, f, p).data, x = u(!0, f, p, y), g = u(!1, f, p, y), P = l(!0, f, p, y), v = l(!1, f, p, y), D = v - P + 1, M = g - x + 1, C = c.getImageData(P, x, D, M);
...
(function(t, o) {
  (function(n, e) {
    ...
    return function(a) {
      ...
      }(), P = l(1), v = r(P), D = l(2), M = r(D), C = l(3), W = r(C), H = l(4), $ = r(H), L = function(m) {
        function d() {
          var b, w, h, A;
          f(this, d);
...
var V = I.exports;
const nt = /* @__PURE__ */ Y(V), rt = /* @__PURE__ */ K({
  __proto__: null,
  default: nt
}, [V]);
export {
